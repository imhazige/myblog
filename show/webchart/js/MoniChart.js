(function() {
	...
	window.MoniChart = function(ops) {
		...
		var lasttextrenderfn = ops.lasttextrenderfn?ops.lasttextrenderfn:function(v,gc){
			return gc;
		}
		...
		this.show = function(ops) {
			...
			buffer.push(lasttextrenderfn(vs[vs.length - 1],r.text(curp0x + off_lasttext, curp0y - 2,
